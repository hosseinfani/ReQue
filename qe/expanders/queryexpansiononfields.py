import sys,traceback,os, subprocess, nltk,string, math
...
class QueryExpansionOnFields:
    ...
    def extract_raw_documents(self,docid):
        ...
        cmd= anserini_address+"/target/appassembler/bin/IndexUtils -index "+index_address+" -dumpRawDoc "+docid
